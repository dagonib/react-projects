      ...
      <form className="flex flex-col sm:flex-row gap-4">
          <div className="flex flex-col gap-4 flex-1">
            ...
            <div className="flex gap-6 flex-wrap">
              ...
              <div className="flex gap-2">
                <input type="checkbox" id="parquing" className="w-5" />
                <span>Parquing</span>
              </div>
              <div className="flex gap-2">
          ...
          <div className="flex flex-col flex-1 gap-4">
            ...
            <div className="flex gap-4">
              ...
              <button disabled={uploading} type="button" onClick={handleIamgeSubmit} className="p-3 text-green-700 border border-green-700 rounded uppercase hover:shadow-lg disabled:opacity-80">{uploading ? 'Uploading...' : 'Upload'}</button>
